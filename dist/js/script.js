...
/* harmony import */ var _hideMidal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hideMidal */ "./src/js/blocks/hideMidal.js");
/* harmony import */ var _openModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./openModal */ "./src/js/blocks/openModal.js");
  ...
  function postData(form) {
    form.addEventListener('submit', event => {
      ...
      function showThanksModal(message) {
        ...
        Object(_openModal__WEBPACK_IMPORTED_MODULE_2__["default"])();
        setTimeout(() => {
          Object(_hideMidal__WEBPACK_IMPORTED_MODULE_1__["default"])();
          thanks.remove();
...
const menuCards = () => {
  ...
  new Card("img/tabs/elite.jpg", "elite", 'Меню "Премиум"', 'В меню "Премиум" мы используем не только красивый дизайн упаковки, но и качественное исполнение блюд. Красная рыба, морепродукты, фрукты - ресторанное меню без похода в ресторан!', 20, '.menu__field .container', 'menu__item').render();
  new Card("img/tabs/post.jpg", "post", 'Меню "Постное"', 'Меню “Постное” - это тщательный подбор ингредиентов: полное отсутствие продуктов животного происхождения, молоко из миндаля, овса, кокоса или гречки, правильное количество белков за счет тофу и импортных вегетарианских стейков.', 15, '.menu__field .container', 'menu__item').render();
};
